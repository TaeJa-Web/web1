...
<main role="main">
  ...
  <div class="jumbotron">
    ...
    <div class="container">
      <h1 class="display-3">Our Contact Information</h1>
      <p>Location: 1414 W brodway</p>
      <p>Currently Dine-in and take out is available !!</p>
      <p><a class="btn btn-primary btn-lg" href="https://www.google.ca/maps/place/Masa+Japanese+Restaurant+Vancouver/@49.2633914,-123.1366221,15z/data=!4m5!3m4!1s0x0:0x50f879aff9d35c2d!8m2!3d49.2633914!4d-123.1366221" role="button">See maps &raquo;</a></p>
    </div>
  </div>

  <div class="container">
    <!-- Example row of columns -->
    <img src="https://www.ikea.com/images/contact-us-b1b091d01713bb633d763c9f748c06d4.jpg" alt="contact" id="contact">
    <div class="row">
      <div class="col-md-8" id="number">
        <h2>Our Address</h2>
        <p>1414 W broadway, Vancouver, BC, V6H 1H4</p>
      <hr>
        <h2>Phone number</h2>
        <p>+1 604-732-0112</p>
      </div>
